            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <Card>
                    ...
                    <CardContent>
                                        ...
                                        <TableCell className="align-top py-1">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <div className="flex flex-col gap-1.5">
                                                        <FormControl>
                                                            <Input {...field} placeholder={t('egQuantityExample')} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </div>
                                                )}
                        ...
                        >
                            <FontAwesomeIcon icon={faPlusCircle} className="mr-2" /> {t('addItem')}
                        </Button>
                        <div className="mt-4 flex items-center justify-between">
                            <span>
                                {t('total')}: R$ {totalAmount.toFixed(2)}
                            </span>
                            <div>{isSaving ? t('saving'): t('savePurchase')}</div>
                        </div>
                    </CardContent>
                ...
                <div className="flex justify-end">
                    <Button type="submit" size="lg" disabled={isSaving} data-analytics-id="save-manual-purchase-button">
                        ...
                        {isSaving ? t('saving'): t('savePurchase')}
                    </Button>
                </div>
            </form>
        </Form>
