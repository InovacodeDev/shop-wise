...
import { Product as AIProduct, ExtractProductDataOutput } from "@/types/ai-flows";
...
export function PdfImportComponent({ onSave }: PdfImportProps) {    const { t, locale } = useI18n();
